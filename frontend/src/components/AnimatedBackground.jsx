...
const AnimatedBackground = () => {
  return (
    <div id="bg-wrap">
      <svg viewBox="0 0 100 250" preserveAspectRatio="xMidYMid slice">
        <defs>
          {/* Define Gradient 1 */}
        ...
        {/* Rectangle 1 */}
        <rect
          x="13.744%" y="1.18473%" width="100%" height="100%"
          fill="url(#Gradient1)"
        ...
        {/* Rectangle 2 */}
        <rect
          x="-2.17916%" y="35.4267%" width="100%" height="100%"
          fill="url(#Gradient2)"
        ...
        {/* Rectangle 3 */}
        <rect
          x="9.00483%" y="14.5733%" width="100%" height="100%"
          fill="url(#Gradient3)"
